...
def _index_points(points, idx):
    """Gather batched points with batched indices."""
...
def fps(xyz, npoint):
    """Pure-PyTorch farthest-point sampling used by Point-BERT grouping."""
    ...
    for index in range(npoint):
        ...
        distance = torch.minimum(distance, torch.sum((xyz - centroid) ** 2, dim=-1))
